...
This file `config.js` is where system wide configuration is set.
...
module.exports = {
  ...
  'crawler_port': [22], //ssh ports [22, 23, 24, ...]
  ...
  'ranges': [ //these are the ranges crawlers will use to look for servers
    {
      'start': '192.168.1.0',
      'end': '192.168.20.225'
    },
